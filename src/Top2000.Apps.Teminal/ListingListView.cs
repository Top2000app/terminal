...
///// <summary>Implement <see cref="IListingListDataSource"/> to provide custom rendering for a <see cref="ListingListView"/>.</summary>
//public interface IListingListDataSource: IDisposable
//{
//    /// <summary>
...
///// <remarks>
/////     <para>
/////         The <see cref="ListingListView"/> displays lists of data and allows the user to scroll through the data. Items in
...
/////     </para>
/////     <para>
/////         By default <see cref="ListingListView"/> uses <see cref="object.ToString"/> to render the items of any
/////         <see cref="ObservableCollection{T}"/> object (e.g. arrays, <see cref="List{T}"/>, and other collections). Alternatively, an
/////         object that implements <see cref="IListingListDataSource"/> can be provided giving full control of what is rendered.
/////     </para>
/////     <para>
/////         <see cref="ListingListView"/> can display any object that implements the <see cref="IList"/> interface.
...
/////         rendering via <see cref="IListingListDataSource"/>) or call <see cref="SetSource"/> an <see cref="IList"/> is being
/////         used.
/////     </para>
/////     <para>
...
//    /// <summary>Gets or sets whether this <see cref="ListingListView"/> allows items to be marked.</summary>
//    /// <value>Set to <see langword="true"/> to allow marking elements of the list.</value>
//    /// <remarks>
//    ///     If set to <see langword="true"/>, <see cref="ListingListView"/> will render items marked items with "[x]", and
...
//    /// <summary>
//    ///     Gets the <see cref="CollectionNavigator"/> that searches the <see cref="ListingListView.Source"/> collection as the
//    ///     user types.
//    /// </summary>
...
//    /// <summary>Gets or sets the <see cref="IListingListDataSource"/> backing this <see cref="ListingListView"/>, enabling custom rendering.</summary>
//    /// <value>The source.</value>
//    /// <remarks>Use <see cref="SetSource"/> to set a new <see cref="IList"/> source.</remarks>
//    public IListingListDataSource Source
//    {
//        get => _source;
//        set
//        {
...
//                                    AllowsMultipleSelection ? ConfigurationManager.Glyphs.CheckStateUnChecked : Glyphs.UnSelected
//                                   );
//                    Driver.AddRune ((Rune)' ');
//                }
...
//    /// <summary>This event is invoked when this <see cref="ListingListView"/> is being drawn before rendering.</summary>
//    public event EventHandler<ListViewRowEventArgs> RowRender;

//    /// <summary>This event is raised when the selected item in the <see cref="ListingListView"/> has changed.</summary>
...
//    /// <summary>Sets the source of the <see cref="ListingListView"/> to an <see cref="IList"/>.</summary>
//    /// <value>An object implementing the IList interface.</value>
//    /// <remarks>
//    ///     Use the <see cref="Source"/> property to set a new <see cref="IListingListDataSource"/> source and use custom
//    ///     rendering.
//    /// </remarks>
//    public void SetSource<T> (List<T> source)
//    {
//        if (source is null && Source is not ListingListWrapper<T>)
//        {
//            Source = null;
//        }
//        else
//        {
//            Source = new ListingListWrapper<T> (source);
//        }
//    }
...
//    ///     rendering.
//    /// </remarks>
//    public Task SetSourceAsync<T> (List<T> source)
//    {
//        return Task.Factory.StartNew (() =>
//        {
//            if (source is null && (Source is null || !(Source is ListingListWrapper<T>)))
//            {
//                Source = null;
//            }
//            else
...
//    {
//        var source = new ListingListWrapper<string> (["List Item 1", "List Item two", "List Item Quattro", "Last List Item"]);
//        Source = source;
...
/// <summary>
///     Provides a default implementation of <see cref="IListingListDataSource"/> that renders <see cref="ListingListView"/> items
///     using <see cref="object.ToString()"/>.
/// </summary>
public class ListingListWrapper<T> : IListDataSource, IDisposable
{
    private int _count;
    ...
    /// <inheritdoc/>
    public ListingListWrapper(List<T> source)
    {
        if (source is { })
        {
            _count = source.Count;
